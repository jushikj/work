                ...
                <div class="form-group-content">
                    <div class="cl">
                      ...
                      <div class="fl">
                        ...
                        <div>
                          <span id='page-portal-ansys-lsdyna-work-dir' style="display: inline-block;"></span>
                          <a id='page-portal-ansys-lsdyna-workdir-btn' style="display: inline-block; vertical-align: middle;"></a>
                        </div>
                        <div>
                          <span id='page-portal-ansys-lsdyna-keyword-file' style="display: inline-block;"></span>
                          <a id='page-portal-ansys-lsdyna-keyword-file-btn' style="display: inline-block; vertical-align: middle;"></a>
                        </div>                  
                      </div>
                    </div>
              </div> 
...
<script type="text/javascript" src="/jm_as/CAE/ANSYS_LSDYNA/ANSYS_LSDYNA.help.js"></script>
<script type="text/javascript" src="/jm_as/CAE/ANSYS_LSDYNA/ANSYS_LSDYNA.js"></script>
