            ...
            <div class="form-group active">
                ...
                <div class="form-group-content">
                    <div class="cl">
                      <div class="fl" style="display:inline; margin-right:20px;">
                        <div>
                          <span id='page-portal-comsol-bin' style="display: inline-block;"></span>
                          <a id='page-portal-comsol-bin-btn' style="display: inline-block; vertical-align: middle;"></a>
                        </div>
                        <span id='page-portal-comsol-arguments'/><br/>
                        <div>
                          <span id='page-portal-comsol-work-dir' style="display: inline-block;"></span>
                          <a id='page-portal-comsol-work-dir-btn' style="display: inline-block; vertical-align: middle;"></a>
                        </div>  
                      </div>
                      <div class="fl">
                        <div>
                          <span id='page-portal-comsol-input-mph' style="display: inline-block;"></span>
                          <a id='page-portal-comsol-input-mph-btn' style="display: inline-block; vertical-align: middle;"></a>
                        </div>
                        <span id='page-portal-comsol-ouput-mph'/><br/>
                        <span id='page-portal-comsol-ouput-log'/><br/>
                      </div>
                    </div>
              </div> 
            </div>
...
<script type="text/javascript" src="/jm_as/CAE/COMSOL/COMSOL.help.js"></script>
<script type="text/javascript" src="/jm_as/CAE/COMSOL/COMSOL.js"></script>
