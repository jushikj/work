        ...
        <form>
            ...
            <div class="form-group active">
                ...
                <div class="form-group-content">
                    <div class="cl">
                      <div class="fl" style="display:inline; margin-right:20px;">
                        <span>Run Mode:</span><span id='page-portal-cfx-run-mode'/>
                        <span>Precission:</span><span id="page-portal-cfx-precission"/>
                        <div>
                          <span id='page-portal-cfx-fluent-bin' style="display: inline-block;"></span>
                          <a id='page-portal-cfx-fluent-bin-btn' style="display: inline-block; vertical-align: middle;"></a>
                        </div>
                        <span id='page-portal-cfx-arguments'></span>
                      </div>
                      <div class="fl">
            ...
            <div class="form-group" id="page-portal-cfx-run-parameters-group">
                ...
                <div class="form-group-content">
                    <div class="cl">
                      ...
                      <div class="fl">
                        <span>Time:</span><span id="page-portal-cfx-time-type"/>
                      </div>
                    </div>
                    <div>
                      <span id='page-portal-cfx-res-file' style="display: inline-block;"></span>
                      <a id='page-portal-cfx-res-file-btn' style="display: inline-block; vertical-align: middle;"></a>
                    </div>
              </div> 
            </div>
