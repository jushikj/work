...
SessionUser userObject = SessionUtil.getSessionManagerInstance().getCurrentSessionUser();
%>
...
var portal_abc="<% out.print(userObject.getPasswd()); %>";
var queueJsonData = [];
                ...
                <div class="form-group-content">
                    <div>
                        ...
                        <div>
                            ...
                            <a id='page-portal-Program-Select' style="display: inline-block; vertical-align: middle;"></a>
                        </div>
...
<script type="text/javascript" src="/jm_as/basic/serial/serial.func.js"></script>
<script type="text/javascript" src="/jm_as/basic/serial/serial.help.js"></script>
<script type="text/javascript" src="/jm_as/basic/serial/serial.js"></script>
