...
$(function(){
    ...
    new Gv.Button({
        ...
        //    $("#jobupdate-floatdiv-con").load("template/作业详细信息.html");
        //}
    });
    new Gv.Button({
    ...
    <div class="page-portal-main">
        ...
        <form>
            ...
            <div class="form-group active">
                ...
                <div class="form-group-content">
                    <div>
                        <span id='page-portal-mpitype'></span>
                        <div style="border:1px solid #ccc; width:510px; padding:15px 15px 10px;  margin-bottom:5px;">
                            <span style="display:inline-block; width:130px;">Remote Shell:</span>
                            <span id='page-portal-shell'></span>
                            <br>
                            <span style="display:inline-block; width:130px;">Communication:</span>
                            <span id='page-portal-communication'></span>
                            <br>
                            <span style="display:inline-block; width:130px;">Other Paramaters:</span>
                            <span id='page-portal-other'></span>
                            <br>
                        </div>
                        <span id='page-portal-Basic-params'></span>
                        <div>
                            <span id='page-portal-mpi-envfile' style="display: inline-block;"></span>
                            <a id='page-portal-mpi-envfile-Select' style="display: inline-block; vertical-align: middle;">
                            </a>
                        </div>
                        <div>
                            <span id='page-portal-Program' style="display: inline-block;"></span>
                            <a id='page-portal-Program-Select' style="display: inline-block; vertical-align: middle;">
                            </a>
                        </div>
                        <span id='page-portal-Arguments'></span>
                        <div>
                            <span id='page-portal-WorkingDIR' style="display: inline-block;"></span>
                            <a id='page-portal-WorkingDIR-Select' style="display: inline-block; vertical-align: middle;">
                            </a>
                        </div>
                        <span id='page-portal-InputFile'></span>
                        <span id='page-portal-Subroutine'></span>
...
<script type="text/javascript" src="/jm_as/basic/mpi/mpi.func.js"></script>
<script type="text/javascript" src="/jm_as/basic/mpi/mpi.help.js"></script>
<script type="text/javascript" src="/jm_as/basic/mpi/mpi.js"></script>
<div class="jobupdate-floatdiv-bottom">
<span id="job-Submission-preset" onClick="formPredefine()"></span>
<span id="job-Submission-do" onClick="mySubmit()"></span>
<span id="job-Submission-close" onClick="formReset()"></span>
</div>
</body>
</html>
