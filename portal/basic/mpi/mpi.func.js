...
function mySubmit() {
    ...
    //get remote shell selection
    var remote_shell_selection = "";
    if ($("#portal_pbs_params_remote_shell_ssh").attr("checked") == "checked") {
        remote_shell_selection = "ssh";
    } else
        remote_shell_selection = "rsh";

    //get communication selection
    communication_selection = "";
    if ($("#portal_pbs_params_communication_infiniband").attr("checked") == "checked")
        communication_selection = "infiniband";
    else
        communication_selection = "tcp";
    ...
    var patest = {
        ...
        "GAP_MPI_TYPE"      : "\'" + Gv.get("portal_pbs_params_mpitype").val() + "\'",
        "GAP_REMOTE_SHELL"  : "\'" + remote_shell_selection + "\'",
        "GAP_COMMUCATION"   : "\'" + communication_selection + "\'",
        ...
        "GAP_OUTPUT"        : "\'" + Gv.get("portal_pbs_params_output").val()+"\'",

        "GAP_VNC"           : "\'"+ Gv.get("portal-pbs-params-vnc").attr("checked")+"\'",

        "GAP_CKECK_POINT"   : "\'" + Gv.get("portal-pbs-params-checkpoint").attr("checked")+"\'",
    ...
    $.ajax({
        ...
        success: function(response, options) {
            ...
            $("#portal_pbs_params_output").val(PORTALNAM+"_"+new_time_stamp+".txt");
        },

        failure: function(response, options) {
            Gv.msg.error({html:'请求作业提交失败!'});
        }
    });
}
...
function formReset() {
    ...
    $("#portal-pbs-params-programarg").val("");
